...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_LE = 23,                  /* TOKEN_LE  */
  YYSYMBOL_TOKEN_GE = 24,                  /* TOKEN_GE  */
  YYSYMBOL_TOKEN_LPAREN = 25,              /* TOKEN_LPAREN  */
  YYSYMBOL_TOKEN_RPAREN = 26,              /* TOKEN_RPAREN  */
  YYSYMBOL_TOKEN_SEMI = 27,                /* TOKEN_SEMI  */
  YYSYMBOL_TOKEN_DOT = 28,                 /* TOKEN_DOT  */
  YYSYMBOL_TOKEN_PLUS = 29,                /* TOKEN_PLUS  */
  YYSYMBOL_TOKEN_MINUS = 30,               /* TOKEN_MINUS  */
  YYSYMBOL_TOKEN_MUL = 31,                 /* TOKEN_MUL  */
  YYSYMBOL_TOKEN_DIV = 32,                 /* TOKEN_DIV  */
...
static const char *const yytname[] =
{
  ...
  "TOKEN_CREATE", "TOKEN_IDENTIFIER", "TOKEN_INTEGER", "TOKEN_REAL",
  "TOKEN_STRING", "TOKEN_ASSIGN", "TOKEN_EQUAL", "TOKEN_LT", "TOKEN_GT",
  "TOKEN_LE", "TOKEN_GE", "TOKEN_LPAREN", "TOKEN_RPAREN", "TOKEN_SEMI",
  "TOKEN_DOT", "TOKEN_PLUS", "TOKEN_MINUS", "TOKEN_MUL", "TOKEN_DIV",
